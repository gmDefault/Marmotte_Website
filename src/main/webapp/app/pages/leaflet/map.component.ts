...
export class MapComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const text_red =
            ...
            'Niveau de batterie faible :<span style="color:red"> 6 % </span><br>Temps restant estimé : <span style="color:red">35 minutes </span><br>Opération nécessaire : <span style="color:red">changer la batterie</span>';
        const text_green =
