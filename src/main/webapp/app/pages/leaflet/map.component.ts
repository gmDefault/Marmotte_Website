...
export class MapComponent implements OnInit, OnDestroy {
    ...
    layersControl = {
        ...
        overlays: {
            ...
            "Marmotte capturée (attente d'intervention)": this.fams3C2
        }
    };
    ...
    ngOnInit() {
        ...
        this.options.layers.push(this.fams3C1.bindPopup(text_green));
        this.options.layers.push(this.fams3C2.bindPopup(text_orange));
